...
function channel_val() {
    ...
    if (((ch1_target_val < 0.007) && (ch1_target_val > -0.006)) || ((ch2_target_val < 0.007) && (ch2_target_val > -0.006)) || ((ch3_target_val < 0.007) && (ch3_target_val > -0.006)) || ((ch4_target_val < 0.007) && (ch4_target_val > -0.006))) {
        if (count >= 20) {
            ch1 = parseInt(ch_mid_val);
            ch2 = parseInt(ch_mid_val);
            ch3 = parseInt(ch_mid_val);
