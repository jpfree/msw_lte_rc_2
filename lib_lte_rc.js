...
function channel_val() {
    ...
    if (((ch1_target_val < 0.6) && (ch1_target_val > 0.4)) || ((ch2_target_val < 0.6) && (ch2_target_val > 0.4)) || ((ch3_target_val < 0.6) && (ch3_target_val > 0.4)) || ((ch4_target_val < 0.6) && (ch4_target_val > 0.4))) {
        if (count >= 20) {
            ch1 = parseInt(ch_mid_val);
            ch2 = parseInt(ch_mid_val);
            ch3 = parseInt(ch_mid_val);
